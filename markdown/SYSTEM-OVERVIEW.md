...
- ล็อกอินด้วยอีเมลหรือ Google มี “จดจำฉัน” เริ่มต้นไม่เลือก: หากเลือกสร้าง session และ cookie อายุสูงสุด 30 วัน หากไม่เลือกใช้ session cookie ที่ไม่กำหนดวันหมดอายุในเบราว์เซอร์ และจำกัด session ในฐานข้อมูลสูงสุด 8 ชั่วโมง ใช้ HttpOnly, SameSite=Lax และ Secure เมื่อเป็น production การเปลี่ยนรหัสผ่านรักษาตัวเลือกนี้ไว้
